...
# 3. التنسيق (الأزرار العريضة والخط الأسود السادة)
st.markdown("""
    <style>
    ...
    * { font-family: 'Arial', sans-serif !important; }
    ...
    .section-title { text-align: right !important; font-size: 22px; font-weight: bold; margin-bottom: 10px; }

    /* الأزرار الصفراء العريضة */
    div.stButton > button {
        ...
        border-radius: 10px !important; margin-bottom: 12px !important; border: none !important;
    }
...
if df is not None:
    ...
    if st.session_state.page == 'home':
        ...
        # زر أصناف خاصة (دائماً في الأسفل)
    ...
    # --- صفحة المراجعة (إعادة الأزرار المفقودة) ---
        ...
        st.divider()
        # إعادة كبسات زيادة الأصناف (التي حذفت بالخطأ)
        ...
        if st.button("🚀 إرسال الطلب للشركة"):
            ...
            else: st.error("أدخل الاسم أولاً")
